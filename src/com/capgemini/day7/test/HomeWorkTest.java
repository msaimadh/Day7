...
class HomeWorkTest {
	...
	void testHomeworkAssignment() {
		...
		File file = new File("C:\\Users\\msaimadh\\Downloads\\Saimadhuri\\day5\\src\\com\\capgemini\\day5\\MyCalculator.java");
		if (file.exists() && file.isFile()) {
			assign1 = new HomeworkAssignment(file, LocalDate.of(2018, 8, 22));
		}
		file = new File("C:\\Users\\msaimadh\\Downloads\\Saimadhuri\\day5\\src\\com\\capgemini\\day5\\TaxCalculator.java");
		if (file.exists() && file.isFile()) {
			assign2 = new HomeworkAssignment(file, LocalDate.of(2018, 9, 3));
		}
		file = new File("C:\\Users\\msaimadh\\Downloads\\Saimadhuri\\Day4\\src\\com\\capgemini\\day4\\BankAccount.java");
		if (file.exists() && file.isFile()) {
			assign3 = new HomeworkAssignment(file, LocalDate.of(2019, 8, 26));
		}
		file = new File("C:\\Users\\msaimadh\\Downloads\\Saimadhuri\\Day4\\src\\com\\capgemini\\day4\\CurrentBankAccount.java");
		if (file.exists() && file.isFile()) {
